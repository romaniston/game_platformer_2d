...
from modules.player import player_pos_x_val
...
class Projectile(pygame.sprite.Sprite):
    def __init__(self, x, y, velocity_x, velocity_y, who_is):
        ...
        self.who_is = who_is
        self.projectile_sprite, self.projectile_size = set_enemy_projectiles(self.who_is)
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, background, enemy_sprite, enemy_size, WIDTH, player_on_ground_y, player_speed,
                 enemy_dies_sound, who_is, player_pos_y):
        super().__init__()
